<!--Amy Trevaskis 15129275
    Administrators search Page
    with the features of removing
    an item or blocking a user-->
<?php
...
<head>
    ...
    <body>
        ...
        <p> Enter ID to unlist item</p>
        <form class="form-inline" method = "GET" action = "./remove_item.php">
            <div class="form-group mx-sm-3 mb-2">
                <input type="number" class="form-control" placeholder="remove_item:" name = "item_to_remove">
            </div>
            <button type="submit" class="btn btn-primary mb-2">Unlist Item:</button>
        </form>


        <div class = "btn-group-vertical" align = "right" style = "margin-top:60px">
